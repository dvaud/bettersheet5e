...
# How it works
After you fill out the form, a HTML template is generated and it downloads. **The HTML file can be opened locally in your browsers, or it could be uploaded online for free(\*1).**
